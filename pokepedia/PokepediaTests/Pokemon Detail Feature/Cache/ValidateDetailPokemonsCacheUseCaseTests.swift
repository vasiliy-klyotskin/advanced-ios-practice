//
//  ValidateDetailPokemonsCacheUseCaseTests.swift
//  PokepediaTests
//
...
final class DetailPokemonCacheValidator {
...
//    }
    ...
    private func makeSut(
        ...
        line: UInt = #line
    ) -> (DetailPokemonCacheValidator, DetailPokemonStoreSpy) {
        let store = DetailPokemonStoreSpy()
        let sut = DetailPokemonCacheValidator()
